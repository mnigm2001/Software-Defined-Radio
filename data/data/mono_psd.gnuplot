# mono_psd.gnuplut : configuration for plotting (change as needed)
...
plot '../data/mono_demod.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#000088' notitle
...
# plot '../data/mono_filt.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#008800' notitle
...
plot '../data/mono_filt.dat' using 1:2 with lines lt 1 lw 3 lc rgb '#880000' notitle
